...
//        LOG(INFO) << "Clean SSD Cache: BLOCKS->" 
//                  << SSDCache::singleton().block_num
//                  << " MAX:->" 
//                  << SSDCache::singleton().max_block_num;
        while (1) {
...
//    LOG(INFO) << "SSD Cache Block Number: "
//            << this->block_num 
//              << " Max: " 
//              << this->max_block_num;
...
//    LOG(INFO) << "DATA IS IN BLOCK: " << key_info.block_id;
